...
| ------- | ------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| 01      | US01          | Ver una demostración de la aplicación          | **Como** visitante, **deseo** ver una demostración de la aplicación **para** entender rápidamente lo que ofrece                                                                          | 2            |
| 02      | US02          | Visualizar reseñas de la aplicación            | **Como** visitante, **deseo** visualizar reseñas de la aplicación **para** decidir si quiero utilizarla                                                                                  | 3            |
| 03      | US03          | Consultar planes de la aplicación              | **Como** visitante, **deseo** visualizar los planes de suscripción **para** decidir el más adecuado a mis necesidades                                                                    | 3            |
| 04      | US04          | Contactar con soporte de la aplicación         | **Como** visitante, **deseo** poder contactarme con equipo de soporte **para** resolver cualquier duda o acceder a información adicional                                                 | 3            |
| 05      | US05          | Ofrecer servicios como consultor financiero    | **Como** visitante del segmento consultor financiero, **deseo** ofrecer mis servicios **para** tener una fuente adicional de dinero                                                      | 3            |
| 06      | US06          | Conocer normas de privacidad                   | **Como** visitante del segmento emprendedor, **deseo** conocer las normas de privacidad **para** contar con la seguridad que mis datos serán protegidos                                  | 2            |
| 07      | US07          | Visualizar proceso de pago por servicios       | **Como** visitante del segmento consultor financiero, **deseo** visualizar una explicación del sistema de pago a consultores **para** entender el proceso antes de ofrecer mis servicios | 2            |
| 08      | US08          | Registrarse en la aplicación                   | **Como** visitante, **deseo** registrarme en la aplicación **para** utilizar las funcionalidades ofrecidas                                                                               | 5            |
| 09      | US09          | Registrar perfil como consultor financiero     | **Como** consultor financiero, **deseo** ingresar mi experiencia e información relevante **para** atraer posibles clientes                                                               | 5            |
| 10      | US10          | Registrar perfil como emprendedor              | **Como** emprendedor, **deseo** registrar mi emprendimiento y mis necesidades **para** empezar a utilizar la aplicación                                                                  | 5            |
| 11      | US11          | Elegir o actualizar plan de suscripción        | **Como** emprendedor, **deseo** registrar y/o modificar mi plan de suscripción **para** que se adecúe a mis necesidades                                                                  | 5            |
| 12      | US12          | Registrar método de pago por servicios         | **Como** consultor financiero, **deseo** ingresar el método de pago de servicios **para** recibir el pago de los mismos                                                                  | 5            |
| 13      | US13          | Buscar consultores según necesidades           | **Como** emprendedor, **deseo** encontrar a un consultor que tenga experiencia en mi rubro **para** que comprenda mis necesidades                                                        | 5            |
| 14      | US14          | Comparar servicios guardados                   | **Como** emprendedor, **deseo** poder comparar los servicios de distintos consultores **para** elegir el más adecuado                                                                    | 3            |
| 15      | US15          | Publicar servicios y precios                   | **Como** consultor financiero, **deseo** publicar distintos servicios y los precios correspondientes **para** ofrecer varias opciones dependiendo de la necesidad del cliente            | 5            |
| 16      | US16          | Establecer horario de atención                 | **Como** consultor financiero, **deseo** establecer mis horas de trabajo **para** no recibir notificaciones fuera de mi horario laboral                                                  | 3            |
| 17      | US17          | Iniciar un caso de asesoría                    | **Como** emprendedor, **deseo** tener acceso a asesoramiento personalizado **para** poder acceder a préstamos que se adecúen a mis necesidades                                           | 5            |
| 18      | US18          | Aceptar un caso de asesoría                    | **Como** consultor financiero, **deseo** hablar con el emprendedor antes de aceptar el caso **para** entender sus necesidades                                                            | 3            |
| 19      | US19          | Visualizar servicios ofrecidos                 | **Como** consultor financiero, **deseo** visualizar todas las ofertas de servicios de otros consultores **para** poder comparar mis servicios                                            | 3            |
| 20      | US20          | Comunicarse mediante mensajes y casos          | **Como** consultor financiero, **deseo** comunicarme directamente con los clientes **para** ofrecer asesoramiento adecuado                                                               | 8            |
| 21      | US21          | Consultar historial de casos                   | **Como** consultor financiero, **deseo** ver el historial de mensajes **para** hacer seguimiento al caso                                                                                 | 3            |
| 22      | US22          | Enviar documentos adjuntos                     | **Como** consultor financiero, **deseo** poder enviar documentos a través de la aplicación **para** apoyar al cliente y darle información necesaria                                      | 3            |
| 23      | US23          | Recibir actualizaciones de solicitudes         | **Como** emprendedor, **deseo** recibir actualizaciones de mis solicitudes **para** estar al tanto del progreso de las mismas                                                            | 5            |
| 24      | US24          | Recibir alertas de fechas importantes          | **Como** emprendedor, **deseo** recibir alertas sobre fechas importantes **para** poder cumplir con los requisitos a tiempo                                                              | 5            |
| 25      | US25          | Solicitar reseñas de servicios                 | **Como** consultor financiero, **deseo** recibir reseñas de mis servicios **para** atraer a clientes                                                                                     | 3            |
| 26      | US26          | Calificar servicios recibidos                  | **Como** emprendedor, **deseo** calificar a los consultores **para** ayudar a otros emprendedores a tomar decisiones informadas                                                          | 3            |
| 27      | US27          | Visualizar métricas de desempeño               | **Como** consultor financiero, **deseo** visualizar métricas de mi desempeño **para** mejorar mis servicios                                                                              | 8            |
| 28      | US28          | Terminar contrato como consultor financiero    | **Como** consultor financiero, **deseo** poder terminar el contrato **para** no ver mis métricas afectadas si el cliente no sigue las recomendaciones                                    | 3            |
| 29      | US29          | Cancelar contrato como emprendedor             | **Como** emprendedor, **deseo** poder cancelar el contrato **para** no verme afectado si el consultor no cumple las estipulaciones                                                       | 3            |
| 30      | US30          | Leer artículos financieros                     | **Como** emprendedor, **deseo** tener acceso a artículos relacionados **para** incrementar mi conocimiento del tema                                                                      | 2            |
| 31      | US31          | Usar herramientas de simulación                | **Como** emprendedor, **deseo** tener acceso a simuladores de pagos y cuotas **para** estimar los pagos de mis deudas                                                                    | 8            |
| 32      | US32          | Ofrecer talleres financieros gratuitos         | **Como** consultor financiero, **deseo** otorgar talleres financieros gratuitos **para** atraer a posibles clientes                                                                      | 5            |
| 33      | US33          | Hacer seguimientos de ingresos y gastos        | **Como** emprendedor, **deseo** una herramienta que me permita rastrear mis ingresos y gastos **para** tener una visión clara de mi situación financiera                                 | 8            |
| 34      | US34          | Crear presupuestos personalizados              | **Como** emprendedor, **deseo** poder crear presupuestos personalizados basados en mis ingresos y gastos **para** administrar mejor mi dinero                                            | 5            |
